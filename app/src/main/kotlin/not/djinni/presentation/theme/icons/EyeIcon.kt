...
internal val EyeIcon: ImageVector
    get() {
        if (_EyeIcon != null) {
            return _EyeIcon!!
        }
        _EyeIcon = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(9.12566f, 10.6036f, 10.318f, 9.35166f, 11.7888f, 9.35166f)
                curveTo(13.2596f, 9.35166f, 14.452f, 10.6036f, 14.452f, 12.148f)
                curveTo(14.452f, 13.6923f, 13.2596f, 14.9443f, 11.7888f, 14.9443f)
                curveTo(10.318f, 14.9443f, 9.12566f, 13.6923f, 9.12566f, 12.148f)
                close()
            ...
            path(
                ...
                curveTo(14.0525f, 19.9643f, 9.52511f, 19.9643f, 6.33513f, 17.2908f)
                lineTo(1.49513f, 13.23f)
                curveTo(1.18217f, 12.967f, 1f, 12.5689f, 1f, 12.148f)
                curveTo(1f, 11.7271f, 1.18217f, 11.329f, 1.49513f, 11.0659f)
                lineTo(6.33513f, 7.00519f)
                curveTo(9.52511f, 4.3316f, 14.0525f, 4.3316f, 17.2425f, 7.00519f)
                close()
                ...
                curveTo(13.6039f, 6.28685f, 9.9737f, 6.28685f, 7.41197f, 8.42766f)
