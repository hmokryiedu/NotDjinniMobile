...
@Composable
fun JobCategorySelectionAlert(
    categories: List<JobCategory>,
    selected: JobCategory?,
    onDismiss: () -> Unit,
    onApply: (JobCategory) -> Unit
) {
    ...
    Dialog(onDismissRequest = onDismiss) {
        Column(
            ...
            NotDjinniText(
                data = R.string.job_category_dialog_title.toTextData(),
                ...
                NotDjinniText(
                    modifier = Modifier
                        .clickableNoRippleWithoutInterval {
                            onDismiss()
                            onApply(selectedCategory ?: return@clickableNoRippleWithoutInterval)
                        }
                        .padding(NotDjinniTheme.offsets.small),
